...
public class JwsUsingRsaSha256ExampleTest extends TestCase
{
    ...
    public void testVerifyExample() throws NoSuchAlgorithmException, InvalidKeySpecException
    {
    ...
    public void testSignExample() throws InvalidKeySpecException, NoSuchAlgorithmException
    {
