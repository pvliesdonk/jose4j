...
public class Base64Test {
    ...
    public void testKnownDecodings() {
        assertEquals("The quick brown fox jumped over the lazy dogs.", new String(Base64
                .decodeBase64("VGhlIHF1aWNrIGJyb3duIGZveCBqdW1wZWQgb3ZlciB0aGUgbGF6eSBkb2dzLg==".getBytes(StandardCharsets.UTF_8))));
        assertEquals("It was the best of times, it was the worst of times.", new String(Base64
                .decodeBase64("SXQgd2FzIHRoZSBiZXN0IG9mIHRpbWVzLCBpdCB3YXMgdGhlIHdvcnN0IG9mIHRpbWVzLg==".getBytes(StandardCharsets.UTF_8))));
        assertEquals("http://jakarta.apache.org/commmons", new String(Base64
                .decodeBase64("aHR0cDovL2pha2FydGEuYXBhY2hlLm9yZy9jb21tbW9ucw==".getBytes(StandardCharsets.UTF_8))));
        assertEquals("AaBbCcDdEeFfGgHhIiJjKkLlMmNnOoPpQqRrSsTtUuVvWwXxYyZz", new String(Base64
                .decodeBase64("QWFCYkNjRGRFZUZmR2dIaElpSmpLa0xsTW1Obk9vUHBRcVJyU3NUdFV1VnZXd1h4WXlaeg==".getBytes(StandardCharsets.UTF_8))));
    ...
    public void testKnownEncodings() {
        assertEquals("VGhlIHF1aWNrIGJyb3duIGZveCBqdW1wZWQgb3ZlciB0aGUgbGF6eSBkb2dzLg==", new String(Base64
                .encodeBase64("The quick brown fox jumped over the lazy dogs.".getBytes(StandardCharsets.UTF_8))));
        assertEquals(
        ...
        assertEquals("SXQgd2FzIHRoZSBiZXN0IG9mIHRpbWVzLCBpdCB3YXMgdGhlIHdvcnN0IG9mIHRpbWVzLg==", new String(Base64
                .encodeBase64("It was the best of times, it was the worst of times.".getBytes(StandardCharsets.UTF_8))));
        assertEquals("aHR0cDovL2pha2FydGEuYXBhY2hlLm9yZy9jb21tbW9ucw==", new String(Base64
                .encodeBase64("http://jakarta.apache.org/commmons".getBytes(StandardCharsets.UTF_8))));
        assertEquals("QWFCYkNjRGRFZUZmR2dIaElpSmpLa0xsTW1Obk9vUHBRcVJyU3NUdFV1VnZXd1h4WXlaeg==", new String(Base64
                .encodeBase64("AaBbCcDdEeFfGgHhIiJjKkLlMmNnOoPpQqRrSsTtUuVvWwXxYyZz".getBytes(StandardCharsets.UTF_8))));
        ...
        for (int i = 0; i < 4; i++) {
            ...
            if (false) {
                ...
                System.out.println("standard:  [" +
                        Hex.toHexString(decodedStandard) +
                        "] From: [" +
                        StringUtil.newStringUtf8(standard[i]) +
                        "]");
                System.out.println("safe1:     [" +
                        Hex.toHexString(decodedUrlSafe1) +
                        "] From: [" +
                        StringUtil.newStringUtf8(urlSafe1[i]) +
                        "]");
                System.out.println("safe2:     [" +
                        Hex.toHexString(decodedUrlSafe2) +
                        "] From: [" +
                        StringUtil.newStringUtf8(urlSafe2[i]) +
                        "]");
                System.out.println("safe3:     [" +
                        Hex.toHexString(decodedUrlSafe3) +
                        "] From: [" +
                        StringUtil.newStringUtf8(urlSafe3[i]) +
                        "]");
            }
    ...
    public void testByteToStringVariations() {
        ...
        final byte[] b3 = null;
        final byte[] b4 = Hex.decode("2bf7cc2701fe4397b49ebeed5acc7090");  // for url-safe tests
